...
<head>
  ...
  <title>Image Caption Search</title>
  <style type="text/css">
.loader {
        ...
        <form action="search.php" method="post" enctype="multipart/form-data">
          <div class="input-group">
            ...
            <div class="input-group-append" id="button-addon">
              <button class="btn btn-outline-secondary" style="background-color: rgb(27, 119, 194);color: white;" id="submit2" type="submit" name="submit2" onclick="myFunction()">Search</button>
